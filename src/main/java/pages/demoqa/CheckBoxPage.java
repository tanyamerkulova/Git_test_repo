...
public class CheckBoxPage extends BasePage {
     ...
     */
    private static String CHECK_BOX_INPUT_XPATH = "//input[@type='checkbox'][following-sibling::span[text()='%s']]";

    /**
     * Локатор до чекбокса для нажатия
     */
    private static String CHECK_BOX_XPATH = CHECK_BOX_INPUT_XPATH + "//following-sibling::span[@class='rct-checkbox']";

    /**
     * Локатор до пиктограммы "Свернуть/развернуть"
     */
    private static String BUTTON_TOGGLE = CHECK_BOX_INPUT_XPATH + "/../preceding-sibling::button[@title='Toggle']";
